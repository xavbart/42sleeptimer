...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/03/15 16:29:27 by xbarthe           #+#    #+#              #
...
# It would ping you every 10 minutes and then 7 minutes and 3 minutes before log off.
#
#
...
USE_MAIL=false
MAIL_CMD="mail -s 'Reste 7 minutes' "+$LOGNAME"@student.42.fr"
# this script uses IFTTT to send notifs
#
...
echo "\n-- 30 min elapsed."
sleep 300
# send me a notif + mail optional in 35 min
